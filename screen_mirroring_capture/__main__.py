"""CLI entry point — ``python -m screen_mirroring_capture`` or ``screen-mirroring-capture``."""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Capture live stream URLs via fake screen casting (DLNA / AirPlay / Chromecast)."
        ),
